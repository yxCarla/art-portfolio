...
function changeColumns() {
  ...
  var columnSize = document.getElementById('columnSizing39');
  if (myRange.value == '2') {
    columnSize.classList.add('col-6');
    columnSize.classList.remove('col-3');
    columnSize.classList.remove('col-4');
  ...
  var columnSize = document.getElementById('columnSizing42');
  if (myRange.value == '2') {
    columnSize.classList.add('col-6');
    columnSize.classList.remove('col-3');
    columnSize.classList.remove('col-4');
  ...
  var columnSize = document.getElementById('columnSizing43');
  if (myRange.value == '2') {
    columnSize.classList.add('col-6');
    columnSize.classList.remove('col-3');
    columnSize.classList.remove('col-4');
  ...
  var columnSize = document.getElementById('columnSizing44');
  if (myRange.value == '2') {
    columnSize.classList.add('col-6');
    columnSize.classList.remove('col-3');
    columnSize.classList.remove('col-4');
  ...
  var columnSize = document.getElementById('columnSizing45');
  if (myRange.value == '2') {
    columnSize.classList.add('col-6');
    columnSize.classList.remove('col-3');
    columnSize.classList.remove('col-4');
  ...
  var columnSize = document.getElementById('columnSizing46');
  if (myRange.value == '3') {
